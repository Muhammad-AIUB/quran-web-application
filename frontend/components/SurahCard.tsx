  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-2 font-sans text-sm font-medium text-zinc-800 dark:text-zinc-200">
          {surah.transliteration}
        </p>
        <p className="mt-0.5 font-sans text-sm text-zinc-600 dark:text-zinc-400">{surah.translation}</p>
      </div>
